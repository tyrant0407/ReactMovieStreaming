     ...
     <div className='w-full flex overflow-x-auto h-[50vh] overflow-y-hidden mb-4' >
        {data && data.map((d,i)=>(
            <div key={i} className="min-w-[15%] ml-[1.2vw] bg-[#00000031] rounded-lg overflow-hidden mb-[0.5vw] " >
                <img className='w-full h-[65%]' src={`https://image.tmdb.org/t/p/original/${d.poster_path || d.backdrop_path || d.profile_path}`} alt={d.title || d.name || d.original_title || d.original_name} />
