...
const Cards = ({data,title,showDetails}) => {
  return (
    <div className='w-full h-full px-[7%] flex flex-col  bg-[#16141d]'>
      ...
      {data && data.map((d,i)=>(
        <Link to={`/${d.media_type ? d.media_type : title}/details/${d.id}`} className='relative w-[30vh] mr-[2%] mb-[2%]  border border-[#333232] shadow-[8px_17px_38px_2px_rgba(0,0,0,0.5)] rounded-lg' key={i}>
