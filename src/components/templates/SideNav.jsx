  ...
  return (
    <div className='w-[20%] h-full bg-[#16141d] border-r-2 border-zinc-200 p-5' >
        ...
        <h1 className='text-white text-lg font-bold mt-5 mb-5 ml-8' >New Feeds</h1>
         <Link to='/trending' className='text-white text-s font-semibold hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-5 pl-8' >
         <i className='ri-fire-fill text-[red] mr-2'></i>
         Trending
         </Link>
         <Link to='/popular' className='text-white text-s font-semibold hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-5 pl-8' >
         <i className='ri-bard-fill text-[yellow] mr-2'></i>
         Popular
         </Link>
         <Link to='/movie' className='text-white text-s font-semibold hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-5 pl-8' >
         <i className='ri-movie-2-fill text-[silver] mr-2'></i>
         Movies
         </Link>
         <Link to='/tvshows' className='text-white text-s font-semibold hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-5 pl-8' >
         <i className='ri-tv-2-fill text-[#70b8c1] mr-2'></i>
         TV Shows
         </Link>
         <Link to='/people' className='text-white text-s font-semibold hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-5 pl-8' >
