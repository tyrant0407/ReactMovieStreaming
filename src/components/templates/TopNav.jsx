    ...
    return (
        <div className="w-[100%] h-[10vh] relative flex items-center pl-[25%]" style={{ paddingLeft: leftPadding }}>
            ...
            <input 
                ...
                className='w-[50%] h-[5vh] bg-transparent border-none outline-none text-white' 
            />

            {query.length > 0 && 
                <i 
                    onClick={()=> setquery('')} 
                    className='absolute ri-close-line text-zinc-200 text-xl mr-2 right-[19%]'
                />
            }
                ...
                <div className='w-[50%] max-h-[50vh] bg-zinc-200 rounded absolute top-[100%] left-[28%] z-[100] overflow-auto'>
                    {searchResult.map((s,i)=>(
                        <Link 
                            ...
                            key={i} 
                            className='inline-flex items-center justify-start p-10 w-[100%] border-b-2 border-zinc-100 text-zinc-600 hover:bg-zinc-300 hover:text-black duration-200'
                        >
                            <img 
                                className='w-[20%] rounded-md mr-5 object-cover shadow-lg' 
