    ...
    <div className="container mx-auto px-4 py-8 bg-[#1F1E24]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {info.details.seasons.map((season,index)=>(
          <div key={index} className="bg-[#070707] p-6 rounded-lg">
            <h3 className="text-lg font-semibold mb-4">{season.name}</h3>
            <img src={`https://image.tmdb.org/t/p/original${season.poster_path}`} alt={season.name} className="w-full h-[30vh] object-cover rounded-lg" />
          </div>
        ))}
      </div>
    </div>
      ...
      <div className="flex flex-col md:flex-row md:space-x-8">
        ...
        <div className="md:w-1/3 bg-[#1F1E24] p-2 rounded-lg">
          <div className="bg-[#070707] p-6 rounded-lg">
            <h3 className="text-xl font-semibold mb-4">Tv Details</h3>
